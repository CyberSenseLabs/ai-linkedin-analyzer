...
No Python required. Open [`dashboard/upload.html`](dashboard/upload.html), click **Upload export
...
dashboard/index.html             Generated standalone dashboard (your data, baked in at build time)
dashboard/upload.html            Empty standalone dashboard — load any export via the browser
```
